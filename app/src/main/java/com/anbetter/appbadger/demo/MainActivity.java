...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mTvDeleteNumber;
...
//        mNotificationManager.cancelAll();
        mTvDeleteNumber.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initView() {
        mTvDeleteNumber = (TextView) findViewById(R.id.tv_delete_number);
    }
}
